// ======================================================================
// P02B_485_Bootloader_Commands.v generated from TopDesign.cysch
// 09/12/2019 at 15:45
...
module UART_v2_50_0 (
	...
	cy_clock_v1_0
		#(.id("daa0ea3f-1da6-4088-bc09-3cdcccd9ba3f/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
    ...
    UART_v2_50_0 Upstream_485 (
        ...
        .rx_data(Net_175),
        .rx_clk(Net_176));
    defparam Upstream_485.Address1 = 0;
    defparam Upstream_485.Address2 = 0;
    defparam Upstream_485.EnIntRXInterrupt = 1;
    defparam Upstream_485.EnIntTXInterrupt = 1;
    defparam Upstream_485.FlowControl = 0;
    defparam Upstream_485.HalfDuplexEn = 0;
    defparam Upstream_485.HwTXEnSignal = 1;
    defparam Upstream_485.NumDataBits = 8;
    defparam Upstream_485.NumStopBits = 1;
    defparam Upstream_485.ParityType = 0;
    defparam Upstream_485.RXEnable = 1;
    defparam Upstream_485.TXEnable = 1;
